...
export const Icons = {
  ...
  fire: () => (
    <svg width="11" height="13" viewBox="0 0 11 13" fill="none">
      <path d="M5.5 1S3 4 3 6.5C3 8.4 4.1 10 5.5 10S8 8.4 8 6.5C8 5.5 7 5 7 4c0-.8.5-1.5.5-1.5S5.5 3 5.5 1z" fill="#b04a2f"/>
      <path d="M2 8c0 2.5 1.6 4 3.5 4S9 10.5 9 8c0-1-.5-1.7-.5-1.7S8 8 5.5 8 2.5 6.3 2.5 6.3 2 7 2 8z" fill="#d68a72"/>
    </svg>
  ),
